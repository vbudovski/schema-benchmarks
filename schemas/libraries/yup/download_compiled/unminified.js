...
//#endregion
//#region ../schemas/libraries/yup/download.ts
const imageSchema = create$3({
	id: create$5().required(),
	created: create$4().required(),
	title: create$6().min(1).max(100).required(),
	type: create$6().oneOf(["jpg", "png"]).required(),
	size: create$5().required(),
	url: create$6().url().required()
});
...
create$3({
	...
	created: create$4().required(),
	title: create$6().min(1).max(100).required(),
	brand: create$6().min(1).max(30).required(),
	description: create$6().min(1).max(500).required(),
	price: create$5().min(1).max(1e4).required(),
	discount: create$5().min(1).max(100).required().nullable(),
	quantity: create$5().min(0).max(10).required(),
	tags: create$2(create$6().min(1).max(30).required()).required(),
	images: create$2(imageSchema).required(),
	ratings: create$2(ratingSchema).required()
}).validate({});
//#endregion
